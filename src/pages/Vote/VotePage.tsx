...
import { TokenAmount, JSBI } from '@pandaswap/sdk'
import { useActiveWeb3React } from '../../hooks'
import { AVERAGE_BLOCK_TIME_IN_SECS, COMMON_CONTRACT_NAMES, BAMBOO, ZERO_ADDRESS } from '../../constants'
...
export default function VotePage({
  ...
  const uniBalance: TokenAmount | undefined = useTokenBalance(
    account ?? undefined,
    chainId ? BAMBOO[chainId] : undefined
  )
