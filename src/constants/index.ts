import { ChainId, JSBI, Percent, Token, WETH } from '@pandaswap/sdk'
...
// BAMBOO
export const BAMBOO: ChainTokenMap = {
  ...
  [ChainId.ROPSTEN]: new Token(
    ChainId.ROPSTEN,
    '0x14594c8A9c4D5aB691CeEAddD0213Fd05177AFb8',
    18,
    'BAMBOO',
    'BambooToken'
  ),
  [ChainId.FUJI]: new Token(
    ChainId.FUJI,
    '0x31B3CC52e7A3AAD2DaB91dC090D67818c6f7f30F',
    18,
    'BAMBOO',
    'BambooToken'
  ),
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.MAINNET]: [
    [BAMBOO[ChainId.MAINNET] as Token, WETH[ChainId.MAINNET]],
    [
