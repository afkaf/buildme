import { Trade, TradeType } from '@pandaswap/sdk'
      ...
      <AutoColumn style={{ padding: '0 16px' }}>
        ...
        <RowBetween>
          ...
          <RowFixed>
            ...
            <QuestionHelper text="A portion of each trade (0.25%) goes to liquidity providers (LP) as a protocol incentive, and (0.05%) to xBAMBOO holders." />
          </RowFixed>
        </RowBetween>
      </AutoColumn>
    </>
