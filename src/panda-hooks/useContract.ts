...
import BAMBOO_ABI from '../constants/bambooAbis/sushi.json'
import MASTERCHEF_ABI from '../constants/bambooAbis/masterchef.json'
import FACTORY_ABI from '../constants/bambooAbis/factory.json'
import ROUTER_ABI from '../constants/bambooAbis/router.json'
import BAR_ABI from '../constants/bambooAbis/bar.json'
import MAKER_ABI from '../constants/bambooAbis/maker.json'
import TIMELOCK_ABI from '../constants/bambooAbis/timelock.json'
// import BENTOBOX_ABI from '../constants/bambooAbis/bentobox.json'
import BASEINFO_ABI from '../constants/bambooAbis/baseInfo.json'
import USERINFO_ABI from '../constants/bambooAbis/userInfo.json'
import MAKERINFO_ABI from '../constants/bambooAbis/makerInfo.json'
import DASHBOARD_ABI from '../constants/bambooAbis/dashboard.json'
import DASHBOARD2_ABI from '../constants/bambooAbis/dashboard2.json'
import PENDING_ABI from '../constants/bambooAbis/pending.json'
// import BENTOHELPER_ABI from '../constants/bambooAbis/bentoHelper.json'

// import SAAVE_ABI from '../constants/bambooAbis/saave.json'
...
export function useSushiContract(withSignerIfPossible = true): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && BAMBOO_ADDRESS[chainId], BAMBOO_ABI, withSignerIfPossible)
}
...
export function useBambooBarContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
