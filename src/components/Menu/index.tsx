...
const CODE_LINK = 'https://github.com/Pandaswapdex/pandaswap-exchange'
...
export default function Menu() {
  ...
  return (
    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          <MenuItem id="link" href="https://pandaswap.info">
            <Info size={14} />
            About
          </MenuItem>
          {/* <MenuItem id="link" href="https://pandaswap.gitbook.io/pandaswap/">
            <BookOpen size={14} />
            Docs
          </MenuItem> */}
          ...
          <MenuItem id="link" href="https://discord.gg/E4Knd3V4gn">
            <MessageCircle size={14} />
            Discord
          </MenuItem>
          {/* <MenuItem id="link" href="https://analytics.pandaswap.com/">
            <PieChart size={14} />
            Analytics
          </MenuItem> */}
